...
import pruebaImagen from '../imagenes/prueba.png'
  ...
  return (
    <Card data-bs-theme={props.darkMode ? 'dark' : 'light'} style={{ width: '18rem', height: '550px' }}>
      ...
      >
        <Card.Img
          variant="top"
          src={pruebaImagen} // Utiliza la imagen importada aquí
          style={{ height: '200px' }}
        />
        {showVideo && (
          <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%'}}>
            <Youtube videoId="nMp3MlTz9fA" opts={videoOpts} className="video"/>
          </div>
        )}
      </div>
      <Card.Body>
